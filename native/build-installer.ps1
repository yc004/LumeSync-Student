param(
  [string]$SourceDir = "dist/student-native",
  [string]$OutputDir = "dist/installer",
  [string]$OutputName = "LumeSync Student Native Setup 1.0.0.exe"
)
...
$ScriptPath = Join-Path $RepoRoot "native/installer/student-native.nsi"
